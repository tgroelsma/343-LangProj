...
#line 7 "zoomjoystrong.y" /* yacc.c:339  */
...
static const char *const yytname[] =
{
  ...
  "statementlist", "statement", "line_command", "point_command",
  "circle_command", "rectangle_command", "set_color_stmt", YY_NULLPTR
};
#endif
...
{
      -5,    -4,    -3,    -2,    -1,     0,     5,     8,     9,    10,
      11,    12,    13,     2,    14,    15,    16,    17,    -6,    -6,
      -6,    -6,    -6,    -6,    -6,    -6,    18,    19,    20,    21,
      22,    -6,    23,    -6,    -6,    -6
};
...
#line 60 "zoomjoystrong.y" /* yacc.c:1646  */
    { printf("Line from %d, %d to %d, %d",(yyvsp[-3].ival), (yyvsp[-2].ival), (yyvsp[-1].ival), (yyvsp[0].ival)); line((yyvsp[-3].ival), (yyvsp[-2].ival), (yyvsp[-1].ival), (yyvsp[0].ival)); }
#line 1233 "zoomjoystrong.tab.c" /* yacc.c:1646  */
    break;

  case 10:
#line 64 "zoomjoystrong.y" /* yacc.c:1646  */
    { printf("Point at %d, %d",(yyvsp[-1].ival),(yyvsp[0].ival)); point((yyvsp[-1].ival), (yyvsp[0].ival)); }
#line 1239 "zoomjoystrong.tab.c" /* yacc.c:1646  */
    break;

  case 11:
#line 68 "zoomjoystrong.y" /* yacc.c:1646  */
    { printf("Circle of radius %d centered at %d, %d", (yyvsp[0].ival), (yyvsp[-2].ival), (yyvsp[-1].ival)); circle((yyvsp[-2].ival), (yyvsp[-1].ival), (yyvsp[0].ival)); }
#line 1245 "zoomjoystrong.tab.c" /* yacc.c:1646  */
    break;

  case 12:
#line 72 "zoomjoystrong.y" /* yacc.c:1646  */
    { printf("Rectangle beginning at %d, %d with height %d and width %d",(yyvsp[-3].ival),(yyvsp[-2].ival),(yyvsp[-1].ival),(yyvsp[0].ival)); rectangle((yyvsp[-3].ival), (yyvsp[-2].ival), (yyvsp[-1].ival), (yyvsp[0].ival)); }
#line 1251 "zoomjoystrong.tab.c" /* yacc.c:1646  */
    break;

  case 13:
#line 76 "zoomjoystrong.y" /* yacc.c:1646  */
    { printf("Setting color to r: %d g: %d b: %d",(yyvsp[-2].ival),(yyvsp[-1].ival),(yyvsp[0].ival)); colorcheck((yyvsp[-2].ival), (yyvsp[-1].ival), (yyvsp[0].ival)); }
...
#line 78 "zoomjoystrong.y" /* yacc.c:1906  */
